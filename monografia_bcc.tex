...
%FIXED-T: PORTANTO APOS REFEIÇÕES AO PUBLICO DO CAMPUS...
      ...
      \section{Objetivos}
        ...
        \subsection{Objetivos específicos}
          ...
          \item Construir realizar análise e comparação da qualidade dos modelos de redes neurais; %XXX SE VAI FAZER OS DOIS, PRECISA MUDAR O TÍTULO, RESUMO, INTRO...
          \end{itemize}
...
%TODO-T: FIGURA 4 ESTORANDO MARGEM DO TÍTULO
          ...
          \paragraph*{Neuronio Artifical}
            ...
            \begin{figure}[H]
              \center{
                \includegraphics[width=0.65\textwidth]                {07-neuronio-operacao-and.png}
              
              \caption{Neuronio Artificial - Operação AND.} \subcaption*{
              Fonte:  http://redesneuraisartificiais.blogspot.com/2010/10/o-primeiro-modelo-de-um-neuronio-criado.html}\label{fig:NeuronioArtificialAnd}}
            \end{figure}
%FIXED-T VIRGULA REMOVIDA DPS DE POSITIVO
        ...
        \subsection{Redes Neurais Artificiais}
          \paragraph*{Perceptron}
            ...
            \caption{Neuronio Artificial Perceptron.} \subcaption*{ retirado de \cite{Junior2007}} \label{fig:perceptron} }
            \end{figure}
	    ...
	    \subsection{Pré-Processamento}
    	    \subsubsection{Divisão dos conjuntos}
    	        \paragraph{Dificuldades encontradas e resolvidas}
                    ...
                    %TREINO
                    \begin{figure}[H]
                    	\center{                    		\includegraphics[width=0.9\textwidth]{./Figuras/resultados/case1_train.png}
                    	\caption{Conjunto verdade de treino, dados de 2017 1o e 2o semestre, e 2018 2o semestre.} \label{fig:case1_train} }
                    \end{figure}
                    %VALIDACAO
                    \begin{figure}[H]
                    	\center{                    		\includegraphics[width=0.9\textwidth]{./Figuras/resultados/case1_val.png}
    	    ...
    	    \subsubsection{Análise das variáveis endógenas}
    	       \textbf{Consumo atual em relação às vendas do 1º dia anterior}
    	    ...
    	    \subsubsection{Análise da sazonalidade semanal}
    	        ...
    	        Nas sextas feiras, o consumo teve escala de distribuição menor para o primeiro semestre de 2019.
    	         \begin{figure}[H]
                	\center{
                		\includegraphics[width=0.6\textwidth]{./Figuras/resultados/case1_segunda.png}
                	
                	\caption{Gráfico violino da distribuição do consumo na segunda feira.} \label{fig:case1_violinplot_segunda} }
                \end{figure}
                \begin{figure}[H]
                	\center{
                		\includegraphics[width=0.6\textwidth]{./Figuras/resultados/case1_terca.png}
                ...
                \begin{figure}[H]
                	\center{
                		\includegraphics[width=0.6\textwidth]{./Figuras/resultados/case1_quarta.png}
                ...
                \begin{figure}[H]
                	\center{
                		\includegraphics[width=0.6\textwidth]{./Figuras/resultados/case1_quinta.png}
                ...
                \begin{figure}[H]
                	\center{
                		\includegraphics[width=0.6\textwidth]{./Figuras/resultados/case1_sexta.png}
    	    ...
    	    \subsubsection{Análise das variáveis exógenas}
    	        \paragraph{Consumo atual em relação ao avanço do semestre}
                    ...
                    \begin{figure}[H]
                    	...
                    	\caption{Correlação da distribuição do consumo com o avanço do semestre.} \label{fig:case1_perc_sem} }
                    \end{figure}
              ...
              \paragraph{Consumo atual em relação ao avanço do mês}
                ...
                \begin{figure}[H]
                    	...
                    	\caption{Correlação da distribuição do consumo com o avanço do mes.} \label{fig:case1_perc_mes} }
                    \end{figure}
                ...
                \begin{figure}[H]
                	...
                	\caption{Gráfico scatter da distribuição do consumo com o avanço do mes.} \label{fig:case1_perc_mes_scatter} }
                \end{figure}
              \paragraph{Variáveis climáticas}
                ...
                \begin{figure}[H]
                	...
                	\caption{Gráfico escatter da distribuição do consumo com a temperatura.} \label{fig:case1_temperatura_scatter_consumo} }
                \end{figure}
                %%%%%%%%%%%%%%%%%%%%%%%%%%%  UMIDADE   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 \begin{figure}[H]
                    	\center{
                ...
                \begin{figure}[H]
                	...
                	\caption{Gráfico escatter da distribuição do consumo com a umidade.} \label{fig:case1_temperatura_scatter} }
                \end{figure}
                %%%%%%%%%%%%%%%%%%%%%%%%%%%  VENTO   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 \begin{figure}[H]
                    	\center{
                ...
                \begin{figure}[H]
                	...
                	\caption{Gráfico escatter da distribuição do consumo com a velocidade do vento.} \label{fig:case1_vento_scatter} }
                \end{figure}
                %%%%%%%%%%%%%%  PRESSAO ATMOSFERICA   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 \begin{figure}[H]
                    	\center{
                ...
                \begin{figure}[H]
                	...
                	\caption{Gráfico escatter da distribuição do consumo com a pressão atmosférica.	} \label{fig:case1_pressao_scatter} }
                \end{figure}
...
RNN\_EXO\_1 1A FASE & -2709 & 5942 & 85.591079711914063 & 90.986939760645683 \\ \hline
	...
	RNN\_EXO\_1  (**) & -3455 & 3247 & 59.541488647460938 & 83.267123246967984
\end{tabular} \end{adjustbox}\subcaption{(**) \textbf{MODELOS TREINADOS NA 2A FASE E TESTADOS NO DOMÍNIO DA 1A FASE}} \end{table} 
