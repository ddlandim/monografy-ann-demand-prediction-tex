	...
	\section{1a Fase Experimental}
	    \subsection{Pré-Processamento}
    	    ...
    	    \subsubsection{Análise das variáveis endógenas}
    	        \paragraph{Consumo atual em relação às vendas do 1º dia anterior}
                    ...
                    \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=1.0\textwidth]
                    		{./Figuras/resultados/feature_sem_outliers.png}
                    	}
                    ...
                    \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=1.0\textwidth]
                    		{./Figuras/resultados/feature_sem_outliers_escalada.png}
                    	}
    	    ...
    	    \paragraph{Análise da técnica do restaurante}
    	        ...
    	        É possível notar que o modelo do R.U é feito para tolerar descartes devido à multa contratual para falta de refeições e o que a produção de 30\% de refeições acima do consumo da semana anterior gera um erro muito maior do que 30\% devido ao comportamento oscilatório do consumo.
    	         \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=1.0\textwidth]
                		{./Figuras/resultados/case1_ru_pred.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=1.0\textwidth]
                		{./Figuras/resultados/case1_ru_pred_scatter.png}
                	}
                ...
                \paragraph{Consumo atual em relação ao consumo do jantar de 1 dia anterior.}
                	...
                	\center{
                		\includegraphics[width=1.0\textwidth]
                		{./Figuras/resultados/case1_consumo_jantar.png}
                	}
                    ...
                    \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=1.0\textwidth]
                    		{./Figuras/resultados/case1_consumo_jantar_scatter.png}
                    	}
    	    ...
    	    \subsubsection{Análise da sazonalidade semanal}
    	        ...
    	        É possível notar que nas sextas feiras, o consumo tem escala de distribuição menor para o primeiro semestre de 2019.
    	         \begin{figure}[!ht]
                	\center{
                		...
                		{./Figuras/resultados/case1_segunda.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_terca.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_quarta.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_quinta.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_sexta.png}
                	}
    	    ...
    	    \subsubsection{Análise das variáveis exógenas}
    	        \paragraph{Consumo atual em relação ao avanço do semestre}
                    ...
                    \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=0.7\textwidth]
                    		{./Figuras/resultados/case1_perc_sem.png}
                    	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_perc_sem_scatter.png}
                	}
              ...
              \paragraph{Consumo atual em relação ao avanço do mês}
                ...
                \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=0.7\textwidth]
                    		{./Figuras/resultados/case1_perc_mes.png}
                    	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_perc_mes_scatter.png}
                	}
              ...
              \paragraph{Variáveis climáticas}
                ...
                \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=0.7\textwidth]
                    		{./Figuras/resultados/case1_temperatura.png}
                    	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_temperatura_scatter.png}
                	}
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%  UMIDADE   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=0.7\textwidth]
                    		{./Figuras/resultados/case1_umidade.png}
                    	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_umidade_scatter.png}
                	}
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%  VENTO   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=0.7\textwidth]
                    		{./Figuras/resultados/case1_vento.png}
                    	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_vento_scatter.png}
                	}
                ...
                %%%%%%%%%%%%%%  PRESSAO ATMOSFERICA   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 \begin{figure}[!ht]
                    	\center{
                    		\includegraphics[width=0.7\textwidth]
                    		{./Figuras/resultados/case1_pressao.png}
                    	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_pressao_scatter.png}
                	}
    	    ...
    	    \subsubsection{Ajuste empírico de topologia com os modelos perceptron}
              ...
              \paragraph{MLP1}
    	        ...
    	        \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_mlp1.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_mlp1_train.png}
                	}
    	        ...
    	        \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_mlp2.png}
                	}
                ...
                \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_mlp2_train.png}
                	}
          ...
          \subsubsection{Modelos Endógenos}
              ...
              \paragraph{MLP\_ENDO\_1}
      	        \begin{figure}[!ht]
                	\center{
                		\includegraphics[width=0.7\textwidth]
                		{./Figuras/resultados/case1_mlp_endo1.png}
                	}
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_mlp_endo1_train.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_mlp_endo1_val.png}
                  }
              ...
              \paragraph{RNN\_ENDO\_1}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_endo1.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_endo1_train.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_endo1_val.png}
                  }
            ...
            %%%%%%%%%%%%%%%%% RNN ENDO 2
              \paragraph{RNN\_ENDO\_2}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_endo2.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_endo2_train.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_endo2_val.png}
                  }
                ...
                \paragraph{Comparativo gráfico da etapa de avaliação no teste no conjunto de validação, entre os melhores modelos endógenos treinados, RNN\_ENDO\_2 e MLP\_ENDO\_1}
                  ...
                  \begin{figure}[!ht]
                      \center{
                        \includegraphics[width=0.7\textwidth]
                        {./Figuras/resultados/case1_gru_mlp_val_analise.PNG}
                      }
            ...
            %%%%%%%%%%%%%%%%% RNN_EXO_1
              \paragraph{RNN\_EXO\_1}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_1.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_1_train.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_1_val.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_1_val_scatter.png}
                  }
              ...
              \paragraph{RNN\_EXO\_2}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_2.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_2_train.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_2_val.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_2_val_scatter.png}
                  }
          ...
          %%%%%%%%%%%%%%%%% RNN_EXO_3
              \paragraph{RNN\_EXO\_3}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_3.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_3_train.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_3_val.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_3_val_scatter.png}
                  }
    	...
    	\subsection{Teste e métricas}
            ...
            \begin{figure}[!ht]
              \center{
                \includegraphics[width=0.7\textwidth]
                {./Figuras/resultados/case1_mlp_endo1_test.png}
              }
            ...
            \begin{figure}[!ht]
              \center{
                \includegraphics[width=0.7\textwidth]
                {./Figuras/resultados/case1_rnn_endo2_test.png}
              }
            ...
            \begin{figure}[!ht]
              \center{
                \includegraphics[width=0.7\textwidth]
                {./Figuras/resultados/case1_rnn_endo2_test_dates.png}
              }
            ...
            \begin{figure}[!ht]
              \center{
                \includegraphics[width=0.7\textwidth]
                {./Figuras/resultados/case1_rnn_endo2_test_scatter.png}
              }
             ...
             %%%%%%%%%%%%%%%%% RNN_EXO\_1
              \paragraph{RNN\_EXO\_1}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_1_test.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case1_rnn_exo_1_test_scatter.png}
                  }
                ...
                \hline ERRO DE PREVISÃO = -3233.18359375 -10.115711137444466 % do total consumido
             ...
             %%%%%%%%%%%%%%%%% RNN_EXO_2
              \paragraph{RNN\_EXO\_2}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case2_rnn_exo_2_test.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case2_rnn_exo_2_test_scatter.png}
                  }
             ...
             %%%%%%%%%%%%%%%%% RNN_EXO_3
              \paragraph{RNN\_EXO\_3}
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case3_rnn_exo_3_test.png}
                  }
                ...
                \begin{figure}[!ht]
                  \center{
                    \includegraphics[width=0.7\textwidth]
                    {./Figuras/resultados/case3_rnn_exo_3_test_scatter.png}
                  }
